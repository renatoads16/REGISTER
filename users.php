...
<body>
    <div class="container d-flex justify-content-center align-items-center">
        <div class="card border-transparent shadow rounded-lg p-4" style="width: auto; height:auto;">
            <main class="container main-container text-center">
                <div class="container d-flex justify-content-between align-items-end  py-1 ">
                    <div>
                        <button class="btn btn-icon" id="goToButton" onclick="returnAdmin()">
                ...
                <div class="row mb-4">
                    <div class="card mb-3 card-full-width">
                        <div class="row g-0">
                            <div class="col-md-4">
                ...
                <div class="card mb-3 card-full-width">
                    <div class="row g-0">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                <p class="card-text">Gabriela de Almeida </p>
